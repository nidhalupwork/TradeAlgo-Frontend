  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-loss text-foreground hover:bg-loss/90 hover:shadow-glow-loss",
        outline:
        ...
        profit:
          "bg-profit text-background font-semibold shadow hover:bg-profit/90 hover:shadow-glow-profit",
        loss:
          "bg-loss text-foreground font-semibold shadow hover:bg-loss/90 hover:shadow-glow-loss",
        gold:
          "bg-gradient-gold text-background font-bold shadow-md hover:shadow-lg hover:scale-105",
        glass:
