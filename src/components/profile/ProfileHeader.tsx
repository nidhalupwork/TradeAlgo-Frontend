...
import { Camera, Settings, CalendarDays, AlertCircle, OctagonX, CircleCheck } from 'lucide-react';
          ...
          <div className='flex-1 space-y-3'>
            <div>
              <div className='flex gap-2 items-center'>
                ...
                {user?.status === 'active' && <CircleCheck className='text-primary' size={25} strokeWidth={2.5} />}
